// ============================================
// ملف: src/routes/order.routes.js (المصحح النهائي مع Validation)
// ============================================
...
// ========== 1. مسارات العملاء (الأكثر تحديداً أولاً) ==========

// مسارات ثابتة (بدون معاملات)
router.get('/me', auth, role('client'), PaginationUtils.validatePaginationParams, orderController.getMyOrdersPaginated);

// مسارات ذات معاملات محددة (تأتي قبل المسار العام)
...
// مسار عام (يجب أن يكون في النهاية)
